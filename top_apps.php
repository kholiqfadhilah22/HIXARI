<?php
$title = "Top Free Android Apps";
$description ="The list of top installed Android apps on HIXARI.";
require_once "library/simple_html_dom.php";
$source = file_get_html("https://www.apkmonk.com/top-apps/"); // Source
  ...
  <div class="row">
    <div class="col-sm-8 border-right border-left">
      ...
      <h3 class="pb-4 mb-4 font-bold border-bottom h3-responsive">
        TOP APPS <span class="badge badge-primary indigo">NEW</span>
      </h3>
      <div class="row">
        <?php
